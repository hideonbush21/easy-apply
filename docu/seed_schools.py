...
if __name__ == "__main__":
    print(f"总共 {len(SCHOOLS)} 所学校")
    print(f"英国: {len([s for s in SCHOOLS if s['country'] == '英国'])}")
    print(f"美国: {len([s for s in SCHOOLS if s['country'] == '美国'])}")
    print(f"澳大利亚: {len([s for s in SCHOOLS if s['country'] == '澳大利亚'])}")
    print(f"\n专业列表 ({len(MAJORS)} 个):")
